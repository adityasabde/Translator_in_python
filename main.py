...
def tt(event=None):
    try:
        word3 = TextBlob(varname1.get())   #python  library use for natural language processing task
...
###############################################################
varname1 = StringVar()
entry1 = Entry(root,width=38,textvariable=varname1,font=('times',15,'italic bold'))
entry1.place(x=150,y=40)

varname2 = StringVar()
entry2 = Entry(root,width=38,textvariable=varname2,font=('times',15,'italic bold'))
entry2.place(x=150,y=100)
#################################################################
label1=Label(root,text='Enter word  :',font=('times',15,'italic bold'),bg='grey')
label1.place(x=5,y=40)

label2=Label(root,text='Translated  :',font=('times',15,'italic bold'),bg='grey')
label2.place(x=5,y=100)

label3=Label(root,text='',font=('times',15,'italic bold'),bg='grey')
label3.place(x=10,y=250)

####################################################################3
btn1= Button(root,text ='Check',bd=10,bg='yellow',activebackground='green',width=10,font=('times',15,'italic bold'),command=tt)
